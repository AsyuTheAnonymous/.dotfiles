...

{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      rebuild-laptop = "sudo nixos-rebuild switch --flake .#asyus-laptop";
      hm-desktop = "home-manager switch --flake .#asyu@asyus-system";
      hm-laptop = "home-manager switch --flake .#asyu@asyus-laptop";
